# TreeBasedDatabaseSimulator.

Olá, Meu nome é Eduardo e esse é o projeto feito na linguagem C o qual foi criado como atividade final de semestre da matéria de estrutura de dados o qual consiste em criar um simulador de banco de dados, no qual o sistema se trata de um cadastro comum mais deves salvar o usuário num banco de dados tenho que passar os dados por uma lista dinâmica, uma lista ligada, e por fim salva-lo numa arvore binaria.
<br>
<br>
<br>
